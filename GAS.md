...
Este archivo contiene el código completo para el Web App de Google Apps Script.
Debe copiarse en su totalidad en el editor de GAS (script.google.com),
asociado a la hoja de cálculo `Seguimiento Egresados — Universidad en el Campo`.

---

## Configuración previa en GAS

1. Abrir el Google Sheet → Extensiones → Apps Script.
2. Borrar el contenido por defecto y pegar todo el código de este archivo.
